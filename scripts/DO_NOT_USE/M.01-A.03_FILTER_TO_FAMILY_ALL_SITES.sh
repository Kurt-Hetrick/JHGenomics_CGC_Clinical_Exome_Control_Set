...
-o $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".VQSR.ANNOTATED.JUST_FAMILY.vcf"

END_FILTER_TO_FAMILY_ALL_SITES=`date '+%s'`

HOSTNAME=`hostname`

echo $FAMILY"_"$PROJECT",N.001,FILTER_TO_FAMILY_ALL_SITES,"$HOSTNAME","$START_FILTER_TO_FAMILY_ALL_SITES","$END_FILTER_TO_FAMILY_ALL_SITES \
